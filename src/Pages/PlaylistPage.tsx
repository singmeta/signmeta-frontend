...
function PlaylistPage() {
  ...
  return (
    <section className="h-screen ">
      <div style={{ fontFamily: "IrishGrover" }} className="flex justify-center justify-center items-center flex-wrap h-full">
        <div className="xl:w-7/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0 border-2 rounded-2xl w-96 h-96">
          <div className="flex justify-between">
            <span className="text-xl text-slate-400 m-5 ml-10 font-bold">플레이리스트</span>
