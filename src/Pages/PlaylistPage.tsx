  ...
  return (
    <section className="h-screen ">
      <div
        ...
        className="flex justify-center items-center flex-wrap h-full"
      >
        <div className="xl:w-7/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0 border-2 rounded-2xl w-96 h-96">
          <div className="flex justify-between">
            ...
            <div className="flex flex-justify ">
              ...
              <button
                type="button"
                className="px-5 h-7 bg-webtn text-white font-medium text-sm rounded-full focus:bg-hoverWebtn focus:shadow-lg focus:outline-none focus:ring-0 active:bg-hoverWebtn active:shadow-lg m-4"
              >
